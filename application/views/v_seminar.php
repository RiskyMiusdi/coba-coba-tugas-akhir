		...
		<div id="home" class="hero-area">
			...
			<div class="home-wrapper">
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							<h1 class="white-text">Pusat Penelitian Kependudukan dan Gender</h1>
							<p class="lead white-text">Just another LPPM Sites site</p>
							<a class="main-button icon-button" href="#">Ayo jelajahi!</a>
						</div>
					</div>
				</div>
			</div>
